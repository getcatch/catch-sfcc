...
var Money = function(value, currencyCode) {
    this.value = value;
    this.decimalValue  = value ? new Decimal(value) : null;
...
Money.prototype.isAvailable = function() { return this.available };
...
Money.prototype.decimalValue  = null;
Money.prototype.available = false;
